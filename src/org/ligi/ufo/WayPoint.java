...
public class WayPoint extends MKPosition {
    ...
    public WayPoint(int[] data, int offset) {
        ...
        setAltitude(MKHelper.parse_arr_4(offset + 8, data));

        setStatus((byte) data[offset + 12]);

        setHeading(MKHelper.parse_arr_2(offset + 13, data));
        ...
        setChannelEvent((byte) data[offset + 20]);
    ...
    public boolean equals(Object o) {
        ...
        if (other_wp.channel_event!=channel_event)
            return false;
